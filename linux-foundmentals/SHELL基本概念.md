...
bat 是一个用 rust 重写的类似 cat 命令的工具，它的功能比 cat 更强大。

官方代码仓库是 https://github.com/sharkdp/bat

它有如下特性：

- 支持大部分编程语言和标记语言的代码高亮。默认显示行号。
- 跟 git 的集成，可以在每一行左侧显示修改状态。
- 可以使用 -A 选项显示和高亮出不可打印字符。
- 自动分页，当打开一个较长文件，自动分页显示。
- 
